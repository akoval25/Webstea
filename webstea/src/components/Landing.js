...
import landingImg from "../images/service-1.png";
    ...
    <section className="landing section__mb section__first">
      <div className="container">
        <div className="inner__mb">
          <h1 className="lng-landing-title text-center">
            {getLangText("landing-title")}
          </h1>
        ...
        <div className="inner__mb component__text-image">
          <div className="content-text">
            <h3 className="lng-landing-first-bold desktop-visible">
              {getLangText("landing-first-bold")}
            </h3>
            <p className="lng-landing-first-description inner__mb">
              {getLangText("landing-first-description")}
            </p>
            <h3 className="lng-landing-second-bold">
              {getLangText("landing-second-bold")}
            </h3>
            <div className="component__list">
              <ul className="list-circle inner__mb">
                <li className="lng-landing-second-a-description">
                  {getLangText("landing-second-a-description")}
                </li>
                <li className="lng-landing-second-b-description">
                  {getLangText("landing-second-b-description")}
                </li>
                <li className="lng-landing-second-c-description">
                  {getLangText("landing-second-c-description")}
                </li>
                <li className="lng-landing-second-d-description">
                  {getLangText("landing-second-d-description")}
                </li>
                <li className="lng-landing-second-e-description">
                  {getLangText("landing-second-e-description")}
                </li>
                <li className="lng-landing-second-f-description">
                  {getLangText("landing-second-f-description")}
                </li>
                <li className="lng-landing-second-g-description">
                  {getLangText("landing-second-g-description")}
                </li>
              </ul>
            </div>
          </div>
          <div className="content-img">
            <h3 className="lng-landing-first-bold mobile-visible text-center">
              {getLangText("landing-first-bold")}
            </h3>
        ...
        <div className="text-center inner__mb">
          <a className="lng-landing-order btn" href="#contact">
            {getLangText("landing-order")}
          </a>
        </div>
        ...
        <div className="section__mb component__list">
          <h3 className="lng-landing-third-bold">
            {getLangText("landing-third-bold")}
          </h3>
          <ul className="list-circle">
            <li className="lng-landing-third-a-description">
              {getLangText("landing-third-a-description")}
            </li>
            <li className="lng-landing-third-b-description">
              {getLangText("landing-third-b-description")}
            </li>
            <li className="lng-landing-third-c-description">
              {getLangText("landing-third-c-description")}
            </li>
            <li className="lng-landing-third-d-description">
              {getLangText("landing-third-d-description")}
            </li>
            <li className="lng-landing-third-e-description">
              {getLangText("landing-third-e-description")}
            </li>
            <li className="lng-landing-third-f-description">
              {getLangText("landing-third-f-description")}
            </li>
            <li className="lng-landing-third-g-description">
              {getLangText("landing-third-g-description")}
            </li>
            <li className="lng-landing-third-h-description">
              {getLangText("landing-third-h-description")}
            </li>
          </ul>
        </div>
      </div>
